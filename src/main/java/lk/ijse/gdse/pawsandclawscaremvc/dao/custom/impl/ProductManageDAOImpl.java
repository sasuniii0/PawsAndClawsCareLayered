...
public class ProductManageDAOImpl implements ProductDAO {
    ...
    public ArrayList<String> getAllProductId() throws SQLException {
        ResultSet rst = SQLUtil.execute("select proId from Product");
    ...
    public ProductDto findById(String selectedProId) throws SQLException {
        ResultSet rst = SQLUtil.execute("select proId,name,description,price,qty from Product where proId=?", selectedProId);

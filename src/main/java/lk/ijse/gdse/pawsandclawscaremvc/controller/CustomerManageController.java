...
import lk.ijse.gdse.pawsandclawscaremvc.view.tdm.CustomerTm;
...
public class CustomerManageController implements Initializable {
    ...
    void DeleteOnClickAction(ActionEvent event) throws SQLException {
        ...
        if (optionalButtonType.isPresent() && optionalButtonType.get() == ButtonType.YES) {
            boolean isDeleted = customerDAOImpl.delete(customerId);
            if (isDeleted) {
                refreshPage();
...
//           e.printStackTrace();
    ...
    private void loadTableData() throws SQLException {
        ArrayList<Customer> customerDtos = customerDAOImpl.getAll();
    ...
    private void loadNextCustomerId() throws SQLException {
        String nextCustomerId = customerDAOImpl.getNextId();
    ...
    void SendMailOnClickAction(ActionEvent event) {
        ...
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/CustMailSend.fxml"));
